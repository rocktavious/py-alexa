...
# These intents are considered default and should be routed to
# if the end user never specified one of these it should then come
# to your function you need to implement as part of your framework
DEFAULT_INTENTS = [
    "LaunchRequest",
    "CancelIntent",
    "StopIntent",
